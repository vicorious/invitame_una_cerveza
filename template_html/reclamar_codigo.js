...
{				
	$("#scan").on('click', function() 
	{
		...
		$('#qr').html5_qrcode(function(data)
		{
		    ...
		    $(".feedback").html('<img src="yes.png" style="height: 20px"></img> Codigo scaneado como: <strong>' +data +'</strong>');
			...
			$("#txtFinal").html('<img src="yes.png" style="height: 20px"></img> Codigo scaneado como: <strong>' +data +'</strong>');
		...
		{
			//show read errors 
			$(".feedback").html('<img src="no.png" style="height: 20px"></img> No es posible escanear el codigo! Error: ' +error)
		},
		function(videoError)
		{
			//the video stream could be opened
			$(".feedback").html('<img src="no.png" style="height: 20px"></img> Error de video: '+videoError);
		}
		);
